Shader "TextMeshPro/Distance Field"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile_local _ USING_SOFT_MASK
            ...
            //AMS UI Soft Mask
            #include_with_pragmas "Assets/ThirdParty/UISoftMask/Shader/Utils/UISoftMask.hlsl"
            ...
            pixel_t VertShader(vertex_t input)
            {
                ...
                //AMS UI Soft Mask
                #ifdef USING_SOFT_MASK
                output.softMaskUV = half3(MaskUV(wPos), input.texcoord1.z);
                #endif
